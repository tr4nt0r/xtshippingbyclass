...
define('MODULE_SHIPPING_SHIPPINGCLASS_TEXT_TITLE', 'Versand nach Versandklassen');
...
define('MODULE_SHIPPING_SHIPPINGCLASS_TEXT_UNITS', 'Versandklasse');
define('MODULE_SHIPPING_SHIPPINGCLASS_INVALID_ZONE', 'Es ist kein Versand in dieses Land m&ouml;glich!');
define('MODULE_SHIPPING_SHIPPINGCLASS_UNDEFINED_RATE', 'Die Versandkosten k&ouml;nnen im Moment nicht berechnet werden.');
...
define('MODULE_SHIPPING_SHIPPINGCLASS_ALLOWED_DESC' , 'Geben Sie <b>einzeln</b> die Zonen an, in welche ein Versand mï¿½glich sein soll. (z.B. AT,DE (lassen Sie dieses Feld leer, wenn Sie alle Zonen erlauben wollen))');
...
define('MODULE_SHIPPING_SHIPPINGCLASS_ZONENAME_'.$ii.'_DESC' , 'Bezeichnung der Versandklasse ' . @constant('MODULE_SHIPPING_SHIPPINGCLASS_ZONENAME_'.$ii) . ' ändern.');
...
define('MODULE_SHIPPING_SHIPPINGCLASS_COST_'.$ii.'_DESC' , 'Versandkosten nach Versandklasse ' . @constant('MODULE_SHIPPING_SHIPPINGCLASS_ZONENAME_'.$ii) . ' Bestimmungsorte. Beispiel: DE:2.95,AT:4.95,CH:14.95,00:19.95 . Für alle übrigen Länder 00 als Ländercode verwenden.');
...
define('MODULE_SHIPPING_SHIPPINGCLASS_SHIPPINGFREEAMOUNT_'.$ii.'_DESC' , 'Bestellwertgrenze für Versandkostenfreie Lieferung');
define('MODULE_SHIPPING_SHIPPINGCLASS_PRIORITY_'.$ii.'_TITLE' , 'Versandklasse ' . @constant('MODULE_SHIPPING_SHIPPINGCLASS_ZONENAME_'.$ii) . ' Priorität');
define('MODULE_SHIPPING_SHIPPINGCLASS_PRIORITY_'.$ii.'_DESC' , 'Priorität der Versandklasse vor anderen Versandklassen. (1 = höchste Priorität)');
...
define('MODULE_SHIPPING_SHIPPINGCLASS_SUMMATE_'.$ii.'_DESC' , 'Die Versandkosten werden für jeden Artikel in Versandklasse ' . @constant('MODULE_SHIPPING_SHIPPINGCLASS_ZONENAME_'.$ii) . ' berechnet, ansonsten nur einmal.');
}
